...
public class Monster {
    ...
    int x, y; // Coordenads x e y del monstru.
    String img; // Imagen del monstruo.
    String name; // Nombre que recibe el monstruo.
    int probabilidadDisparo; // Probabilidad de que se realice un disparo
    ...
    public void disparar() {
        ...
        if (numAzar <= probabilidadDisparo) {
            System.out.println(name + " Dispara"); // Simulación de disparo
        }
    }
