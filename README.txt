Creación de un proyecto SpaceInvaders, en el que se comienza estudiando conceptos de programación orientada a objetos y
se termina construyendo un videojuego completamente funcional. El repositorio se divide en diferentes ramas, cada una va
aportando nuevos aspectos al desarrollo del código. Son ramas incrementables.
